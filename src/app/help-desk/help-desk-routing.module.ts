...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'customer-service/:id', component: HelpDeskMessageComponent },
      { path: 'inbox', component: InboxComponent },
      { path: 'inbox/:id', component: HelpDeskMessageComponent },
      { path: 'outbox', component: SentComponent },
      { path: 'outbox/:id', component: HelpDeskMessageComponent },
      { path: 'archived', component: ArchivedComponent },
      { path: 'archived/:id', component: HelpDeskMessageComponent },
    ],
  },
];
